...
def old_war_check():
    ...
    #adding and Testing
    project.get_dataset("wearhouse_row_compning_ok_month_prepared")
    ...
    #testing start
    total_sum_of_closing_sum_for_old_search = old_war_df_check.where(old_war_df_check['Branch']== war_total_out['Branch'].values[0])
    total_sum_of_closing_sum_for_old = 0
    #testin edn
